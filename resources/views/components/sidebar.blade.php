<aside class="sidebar bg-white shadow-md w-64 h-screen fixed left-0 top-0 flex flex-col">
    ...
    <div class="p-4 border-t border-gray-200 mt-auto">
        ...
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button class="w-full flex items-center justify-center space-x-2 bg-gray-100 hover:bg-gray-200 text-gray-800 p-2 rounded-lg font-medium transition-colors">
