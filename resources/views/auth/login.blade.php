                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <button type="button"
                        ...
                        <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="#EA4335">
                            ...
                            <path
                                d="M5.277 14.268A7.12 7.12 0 0 1 4.909 12c0-.782.125-1.533.357-2.235L1.24 6.65A11.934 11.934 0 0 0 0 12c0 2.934 1.04 5.735 3 7.834l4.04-3.067c-.327-.996-.513-2.05-.513-3.167 0-1.117.186-2.17.513-3.166z" />
                        </svg>
